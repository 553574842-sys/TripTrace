...
import { getUploadDir } from './services/uploadPaths';
...
export function createApp(): express.Application {
    ...
    contentSecurityPolicy: {
      directives: {
        ...
        connectSrc: [
          ...
          "https://*.basemaps.cartocdn.com", "https://*.tile.openstreetmap.org", "https://webrd01.is.autonavi.com",
  ...
  app.use('/uploads/covers', express.static(getUploadDir('covers')));
  app.use('/uploads/journey', express.static(getUploadDir('journey')));
  ...
  app.get('/uploads/photos/:filename', (req: Request, res: Response) => {
    ...
    const photosDir = getUploadDir('photos');
  ...
  // the TripTrace home page instead of the consent form.
  ...
  // Token and revoke keep TripTrace's own handlers (timing-safe hash comparison not supported by SDK clientAuth)
