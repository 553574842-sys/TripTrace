...
import { getDataRoot } from './services/uploadPaths';
...
const rawDefaultLang = process.env.DEFAULT_LANGUAGE?.toLowerCase() || 'zh';
...
export const DEFAULT_LANGUAGE = SUPPORTED_LANG_CODES.includes(rawDefaultLang) ? rawDefaultLang : 'zh';
