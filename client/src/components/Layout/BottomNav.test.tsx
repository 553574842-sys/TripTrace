...
describe('BottomNav', () => {
  ...
  it('FE-COMP-BOTTOMNAV-012: shows Notifications and Settings as primary nav links', () => {
    render(<BottomNav />);
    expect(screen.getByText('Notifications')).toBeInTheDocument();
    expect(screen.getAllByText('Settings').length).toBeGreaterThan(0);
  });

  it('FE-COMP-BOTTOMNAV-013: advanced addon labels are not rendered in primary nav', () => {
    render(<BottomNav />);
