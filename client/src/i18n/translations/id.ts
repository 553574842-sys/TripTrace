const id: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Rekan perjalanan untuk TripTrace',
  'settings.about.supporters.subtitle': 'Saat kamu merencanakan rute berikutnya, orang-orang ini ikut merencanakan masa depan TripTrace. Kontribusi bulanan mereka langsung masuk ke pengembangan dan jam kerja nyata — supaya TripTrace tetap Open Source.',
  ...
  'settings.about.description': 'TripTrace adalah perencana perjalanan self-hosted yang membantu kamu mengatur perjalanan dari ide pertama hingga kenangan terakhir. Perencanaan harian, anggaran, daftar bawaan, foto dan masih banyak lagi — semua di satu tempat, di servermu sendiri.',
  'settings.about.madeWith': 'Dibuat dengan',
  'settings.about.madeBy': 'oleh TripTrace team dan komunitas open-source yang terus berkembang.',
  ...
  'login.createAdminHint': 'Siapkan akun admin pertama untuk TripTrace.',
  ...
  'admin.addons.subtitle': 'Aktifkan atau nonaktifkan fitur untuk menyesuaikan pengalaman TripTrace kamu.',
  ...
  'admin.weather.description': 'TripTrace menggunakan Open-Meteo sebagai sumber data cuaca. Open-Meteo adalah layanan cuaca gratis dan open-source — tidak perlu kunci API.',
  ...
  'admin.github.support': 'Bantu saya terus mengembangkan TripTrace',

  'admin.update.available': 'Pembaruan tersedia',
  'admin.update.text': 'TripTrace {version} tersedia. Kamu menggunakan {current}.',
  'admin.update.button': 'Lihat di GitHub',
  'admin.update.install': 'Pasang Pembaruan',
  'admin.update.confirmTitle': 'Pasang Pembaruan?',
  'admin.update.confirmText': 'TripTrace akan diperbarui dari {current} ke {version}. Server akan restart otomatis setelahnya.',
  ...
  'admin.update.dockerText': 'Instans TripTrace kamu berjalan di Docker. Untuk memperbarui ke {version}, jalankan perintah berikut di servermu:',
  ...
  'vacay.sharingHint': 'Bagikan rencana cuti kamu dengan pengguna TripTrace lainnya',
  'vacay.owner': 'Pemilik',
  'vacay.shareEmailPlaceholder': 'Email pengguna TripTrace',
  ...
  'vacay.inviteHint': 'Undang pengguna TripTrace lain untuk berbagi kalender cuti bersama.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} kini tersedia.',
  ...
  'notif.version_available.text': 'TripTrace {version} kini tersedia',
  ...
  'journey.pdf.madeWith': 'Dibuat dengan TripTrace',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Selamat datang di TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinasi wisata indah dengan antarmuka TripTrace',
