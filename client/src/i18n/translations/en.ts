const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.mapsKey': 'Amap API Key',
  'settings.mapsKeyHint': 'Used for mainland China place search and route planning. Create a Web Service key in Amap Open Platform.',
  ...
  'settings.about.supporters.title': 'Travel companions for TripTrace',
  'settings.about.supporters.subtitle': "While you're planning your next route, these folks are helping plan TripTrace's future. Their monthly contribution goes straight into development and real hours spent — so TripTrace stays Open Source.",
  ...
  'settings.about.description': 'TripTrace is a self-hosted travel planner that helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more — all in one place, on your own server.',
  'settings.about.madeWith': 'Made with',
  'settings.about.madeBy': 'by TripTrace team and a growing open-source community.',
  ...
  'login.createAdminHint': 'Set up the first admin account for TripTrace.',
  ...
  'admin.mapsKey': 'Amap API Key',
  'admin.mapsKeyHint': 'Required for mainland China routes and place search.',
  'admin.mapsKeyHintLong': 'The domestic build uses Amap for driving, walking, and transit route planning. Add an Amap Web Service key here.',
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your TripTrace experience.',
  ...
  'admin.weather.description': 'TripTrace uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building TripTrace',

  'admin.update.available': 'Update available',
  'admin.update.text': 'TripTrace {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText': 'TripTrace will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText': 'Your TripTrace instance runs in Docker. To update to {version}, run the following commands on your server:',
  ...
  'vacay.sharingHint': 'Share your vacation plan with other TripTrace users',
  'vacay.owner': 'Owner',
  'vacay.shareEmailPlaceholder': 'Email of TripTrace user',
  ...
  'vacay.inviteHint': 'Invite another TripTrace user to share a combined vacation calendar.',
  ...
  'dayplan.deleteDayTitle': 'Delete this day?',
  'dayplan.deleteDayBody': '"{title}" and its place assignments, notes, and transport links will be removed. This cannot be undone.',
  ...
  'dayplan.toast.dayDeleted': 'Day deleted',
  'dayplan.toast.deleteDayError': 'Failed to delete day',
  ...
  'places.osmHint': 'Domestic mode works best with an Amap API key for richer place and route data.',
  'places.osmActive': 'Domestic mode works best with an Amap API key for richer place and route data.',
  ...
  'reservations.meta.noHotelPlace': 'Do not link an accommodation',
  ...
  'reservations.attachments': 'Attachments',
  'reservations.attachmentsEmpty': 'No attachments yet. Add a booking screenshot, ticket, or confirmation.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} is now available.',
  ...
  'notif.version_available.text': 'TripTrace {version} is now available',
  ...
  'journey.pdf.madeWith': 'Made with TripTrace',
  'journey.pdf.day': 'Day',
  ...
  'system_notice.welcome_v1.title': 'Welcome to TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'A scenic travel destination with TripTrace planning UI overlay',
  ...
  'transport.ai.title': 'AI autofill',
  'transport.ai.subtitle': 'Paste booking text or upload a screenshot to fill the fields below',
  'transport.ai.placeholder': 'Example: CZ3123, May 13 14:30, Changsha Huanghua to Beijing Daxing, confirmation ABC123...',
  'transport.ai.uploadImage': 'Upload screenshot',
  'transport.ai.action': 'Parse with AI',
  'transport.ai.parsing': 'Parsing...',
  'transport.ai.filled': 'Filled the form from AI results',
  'transport.ai.error': 'AI parsing failed',
  'transport.ai.needInput': 'Enter a description or upload a screenshot first',
  'transport.ai.errorKeyMissing': 'AI API key is not configured. Set AI_API_KEY on the server.',
  'transport.ai.errorKeyInvalid': 'AI API key is invalid or does not have permission.',
  'transport.ai.errorModelUnavailable': 'The configured AI model is unavailable. Check AI_MODEL or choose another model.',
  'transport.ai.errorImageTooLarge': 'The image is too large. Compress it or use text instead.',
  'transport.ai.errorImageUnsupported': 'Unsupported file type. Upload a PNG, JPG, or WebP screenshot.',
  'transport.ai.errorParseFailed': 'AI returned an unsupported format. Try a clearer screenshot or use text instead.',
  'transport.ai.errorEmptyResponse': 'AI did not return recognizable content. Add more details and try again.',
  'transport.ai.errorRateLimited': 'AI quota is exhausted or requests are too frequent. Try again later.',
  'transport.ai.errorTimeout': 'AI parsing timed out. Try again later.',
  'transport.ai.errorProviderUnavailable': 'AI service is unavailable. Check network, Base URL, or try again later.',
  'transport.ai.errorRequestInvalid': 'AI request is invalid. Check the screenshot, text, and model configuration.',
}
