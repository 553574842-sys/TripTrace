const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Compagni di viaggio per TripTrace',
  'settings.about.supporters.subtitle': 'Mentre pianifichi il tuo prossimo itinerario, queste persone aiutano a pianificare il futuro di TripTrace. Il loro contributo mensile va direttamente allo sviluppo e alle ore realmente investite — per mantenere TripTrace Open Source.',
  ...
  'settings.about.description': 'TripTrace è un pianificatore di viaggi self-hosted che ti aiuta a organizzare i tuoi viaggi dalla prima idea all\'ultimo ricordo. Pianificazione giornaliera, budget, liste bagagli, foto e molto altro — tutto in un unico posto, sul tuo server.',
  'settings.about.madeWith': 'Fatto con',
  'settings.about.madeBy': 'da TripTrace team e una crescente comunità open-source.',
  ...
  'login.createAdminHint': 'Imposta il primo account amministratore per TripTrace.',
  ...
  'admin.addons.subtitle': 'Abilita o disabilita le funzionalità per personalizzare la tua esperienza TripTrace.',
  ...
  'admin.weather.description': 'TripTrace utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.',
  ...
  'admin.github.by': 'da',
  'admin.github.support': 'Mi aiuta a continuare a sviluppare TripTrace',

  'admin.update.available': 'Aggiornamento disponibile',
  'admin.update.text': 'TripTrace {version} è disponibile. Stai eseguendo {current}.',
  ...
  'admin.update.confirmText': 'TripTrace verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.',
  ...
  'admin.update.dockerText': 'La tua istanza TripTrace è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti TripTrace',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': 'Email dell\'utente TripTrace',
  ...
  'vacay.inviteHint': 'Invita un altro utente TripTrace a condividere un calendario ferie combinato.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} è ora disponibile.',
  ...
  'notif.version_available.text': 'TripTrace {version} è ora disponibile',
  ...
  'journey.pdf.madeWith': 'Creato con TripTrace',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Benvenuto su TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinazione di viaggio panoramica con l\'interfaccia TripTrace',
