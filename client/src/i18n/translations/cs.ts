const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Společníci na cestě s TripTrace',
  'settings.about.supporters.subtitle': 'Zatímco plánuješ další trasu, tihle lidé plánují společně se mnou budoucnost TripTrace. Jejich měsíční příspěvek jde přímo na vývoj a reálně strávené hodiny — aby TripTrace zůstal Open Source.',
  ...
  'settings.about.description': 'TripTrace je samohostovaný plánovač cest, který vám pomůže organizovat výlety od prvního nápadu po poslední vzpomínku. Denní plánování, rozpočet, balicí seznamy, fotky a mnoho dalšího — vše na jednom místě, na vašem vlastním serveru.',
  'settings.about.madeWith': 'Vytvořeno s',
  'settings.about.madeBy': 'TripTrace teamm a rostoucí open-source komunitou.',
  ...
  'login.createAdminHint': 'Nastavte první administrátorský účet pro TripTrace.',
  ...
  'admin.addons.subtitle': 'Zapněte nebo vypněte funkce a přizpůsobte si TripTrace.',
  ...
  'admin.github.by': 'od',
  'admin.github.support': 'Pomáhá udržovat vývoj TripTrace',

  // Počasí (Weather)
  'admin.weather.title': 'Data o počasí',
  'admin.weather.badge': 'Od 24. března 2026',
  'admin.weather.description': 'TripTrace používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.text': 'TripTrace {version} je k dispozici. Aktuálně používáte verzi {current}.',
  ...
  'admin.update.confirmText': 'TripTrace bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'admin.update.dockerText': 'Váš TripTrace běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  ...
  'vacay.sharingHint': 'Sdílejte svůj plán dovolené s ostatními uživateli TripTrace',
  'vacay.owner': 'Vlastník',
  'vacay.shareEmailPlaceholder': 'E-mail uživatele TripTrace',
  ...
  'vacay.inviteHint': 'Pozvěte jiného uživatele TripTrace ke sdílení společného kalendáře dovolených.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} je nyní k dispozici.',
  ...
  'notif.version_available.text': 'TripTrace {version} je nyní dostupný',
  ...
  'journey.pdf.madeWith': 'Vytvořeno pomocí TripTrace',
  'journey.pdf.day': 'Den',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Vítejte v TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malebné cestovní místo s rozhraním TripTrace',
