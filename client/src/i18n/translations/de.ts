const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Reisebegleitung für TripTrace',
  'settings.about.supporters.subtitle': 'Während du deine nächste Route planst, planen diese Leute mit, wie TripTrace weitergeht. Ihr monatlicher Beitrag fließt direkt in Entwicklung und echten Zeitaufwand — damit TripTrace Open Source bleibt.',
  ...
  'settings.about.description': 'TripTrace ist ein selbst gehosteter Reiseplaner, der dir hilft, deine Trips von der ersten Idee bis zur letzten Erinnerung zu organisieren. Tagesplanung, Budget, Packlisten, Fotos und vieles mehr — alles an einem Ort, auf deinem eigenen Server.',
  'settings.about.madeWith': 'Entwickelt mit',
  'settings.about.madeBy': 'von TripTrace team und einer wachsenden Open-Source-Community.',
  ...
  'login.createAdminHint': 'Erstelle das erste Admin-Konto für TripTrace.',
  ...
  'admin.addons.subtitle': 'Aktiviere oder deaktiviere Funktionen, um TripTrace nach deinen Wünschen anzupassen.',
  ...
  'admin.weather.description': 'TripTrace nutzt Open-Meteo als Wetterdatenquelle. Open-Meteo ist ein kostenloser, quelloffener Wetterdienst — es wird kein API-Schlüssel benötigt.',
  ...
  'admin.github.by': 'von',
  'admin.github.support': 'Hilft mir, TripTrace weiterzuentwickeln',

  'admin.update.available': 'Update verfügbar',
  'admin.update.text': 'TripTrace {version} ist verfügbar. Du verwendest {current}.',
  ...
  'admin.update.confirmText': 'TripTrace wird von {current} auf {version} aktualisiert. Der Server startet danach automatisch neu.',
  ...
  'admin.update.dockerText': 'Deine TripTrace-Instanz läuft in Docker. Um auf {version} zu aktualisieren, führe folgende Befehle auf deinem Server aus:',
  ...
  'vacay.sharingHint': 'Teile deinen Urlaubsplan mit anderen TripTrace-Benutzern',
  'vacay.owner': 'Besitzer',
  'vacay.shareEmailPlaceholder': 'E-Mail des TripTrace-Benutzers',
  ...
  'vacay.inviteHint': 'Lade einen anderen TripTrace-Benutzer ein, um einen gemeinsamen Urlaubskalender zu teilen.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} ist jetzt verfügbar.',
  ...
  'notif.version_available.text': 'TripTrace {version} ist jetzt verfügbar',
  ...
  'journey.pdf.madeWith': 'Erstellt mit TripTrace',
  'journey.pdf.day': 'Tag',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Willkommen bei TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malerisches Reiseziel mit TripTrace-Planungs-UI',
