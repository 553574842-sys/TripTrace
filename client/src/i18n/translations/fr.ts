const fr: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Compagnons de voyage pour TripTrace',
  'settings.about.supporters.subtitle': 'Pendant que tu planifies ton prochain itinéraire, ces personnes aident à planifier l\'avenir de TripTrace. Leur contribution mensuelle va directement au développement et aux heures réellement passées — pour que TripTrace reste Open Source.',
  ...
  'settings.about.description': 'TripTrace est un planificateur de voyage auto-hébergé qui vous aide à organiser vos voyages de la première idée au dernier souvenir. Planification journalière, budget, listes de bagages, photos et bien plus — le tout au même endroit, sur votre propre serveur.',
  'settings.about.madeWith': 'Fait avec',
  'settings.about.madeBy': 'par TripTrace team et une communauté open-source grandissante.',
  ...
  'login.createAdminHint': 'Configurez le premier compte administrateur pour TripTrace.',
  ...
  'admin.addons.subtitle': 'Activez ou désactivez des fonctionnalités pour personnaliser votre expérience TripTrace.',
  ...
  'admin.weather.description': 'TripTrace utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.github.support': 'Aidez à poursuivre le développement de TripTrace',
  'admin.github.error': 'Impossible de charger les versions',
  'admin.github.by': 'par',

  'admin.update.available': 'Mise à jour disponible',
  'admin.update.text': 'TripTrace {version} est disponible. Vous utilisez {current}.',
  ...
  'admin.update.confirmText': 'TripTrace sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'admin.update.dockerText': 'Votre instance TripTrace fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  ...
  'vacay.sharingHint': 'Partagez votre plan de vacances avec d\'autres utilisateurs TripTrace',
  'vacay.owner': 'Propriétaire',
  'vacay.shareEmailPlaceholder': 'E-mail de l\'utilisateur TripTrace',
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur TripTrace à partager un calendrier de vacances combiné.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} est maintenant disponible.',
  ...
  'notif.version_available.text': 'TripTrace {version} est maintenant disponible',
  ...
  'journey.pdf.madeWith': 'Créé avec TripTrace',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bienvenue sur TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destination de voyage pittoresque avec l\'interface TripTrace',
