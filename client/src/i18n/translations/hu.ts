const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Útitársak a TripTrace mellett',
  'settings.about.supporters.subtitle': 'Miközben te a következő útvonaladat tervezed, ők a TripTrace jövőjét tervezik velem együtt. Havi hozzájárulásuk közvetlenül fejlesztésre és valódi órákra fordítódik — hogy a TripTrace Open Source maradhasson.',
  ...
  'settings.about.description': 'A TripTrace egy saját szerveren üzemeltetett útitervező, amely segít az utazásaid megszervezésében az első ötlettől az utolsó emlékig. Napi tervezés, költségvetés, csomagolási listák, fotók és még sok más — minden egy helyen, a saját szervereden.',
  'settings.about.madeWith': 'Készítve',
  'settings.about.madeBy': 'TripTrace team és egy növekvő nyílt forráskódú közösség által.',
  ...
  'login.createAdminHint': 'Hozd létre az első admin fiókot a TripTrace-hez.',
  ...
  'admin.addons.subtitle': 'Funkciók engedélyezése vagy letiltása a TripTrace testreszabásához.',
  ...
  'admin.weather.description': 'A TripTrace az Open-Meteo-t használja időjárás-adatforrásként. Az Open-Meteo egy ingyenes, nyílt forráskódú időjárás-szolgáltatás — nincs szükség API kulcsra.',
  ...
  'admin.github.support': 'Segít fenntartani a TripTrace fejlesztését',

  'admin.update.available': 'Frissítés elérhető',
  'admin.update.text': 'A TripTrace {version} elérhető. Jelenleg a {current} verziót használod.',
  ...
  'admin.update.confirmText': 'A TripTrace frissítésre kerül {current} verzióról {version} verzióra. A szerver ezután automatikusan újraindul.',
  ...
  'admin.update.dockerText': 'A TripTrace példányod Dockerben fut. A {version} verzióra frissítéshez futtasd a következő parancsokat a szervereden:',
  ...
  'vacay.sharingHint': 'Szabadságterved megosztása más TripTrace felhasználókkal',
  'vacay.owner': 'Tulajdonos',
  'vacay.shareEmailPlaceholder': 'TripTrace felhasználó e-mail címe',
  ...
  'vacay.inviteHint': 'Hívj meg egy másik TripTrace felhasználót közös szabadságnaptár megosztásához.',
  ...
  'notifications.versionAvailable.text': 'A TripTrace {version} már elérhető.',
  ...
  'notif.version_available.text': 'A TripTrace {version} elérhető',
  ...
  'journey.pdf.madeWith': 'Készítve a TripTrace segítségével',
  'journey.pdf.day': 'Nap',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Üdvözöl a TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'Festői úticél TripTrace tervező felülettel',
