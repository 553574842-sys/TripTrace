const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Companheiros de viagem do TripTrace',
  'settings.about.supporters.subtitle': 'Enquanto você planeja sua próxima rota, essas pessoas planejam junto o futuro do TripTrace. A contribuição mensal delas vai direto para o desenvolvimento e horas reais investidas — para o TripTrace continuar Open Source.',
  ...
  'settings.about.description': 'TripTrace é um planejador de viagens auto-hospedado que ajuda você a organizar suas viagens da primeira ideia à última lembrança. Planejamento diário, orçamento, listas de bagagem, fotos e muito mais — tudo em um só lugar, no seu próprio servidor.',
  'settings.about.madeWith': 'Feito com',
  'settings.about.madeBy': 'por TripTrace team e uma crescente comunidade open-source.',
  ...
  'login.createAdminHint': 'Configure a primeira conta de administrador do TripTrace.',
  ...
  'admin.addons.subtitle': 'Ative ou desative recursos para personalizar sua experiência no TripTrace.',
  ...
  'admin.weather.description': 'O TripTrace usa Open-Meteo como fonte de clima. Open-Meteo é um serviço gratuito e de código aberto — sem chave de API.',
  ...
  'admin.github.by': 'por',
  'admin.github.support': 'Ajuda a continuar desenvolvendo o TripTrace',

  'admin.update.available': 'Atualização disponível',
  'admin.update.text': 'O TripTrace {version} está disponível. Você está na {current}.',
  'admin.update.button': 'Ver no GitHub',
  'admin.update.install': 'Instalar atualização',
  'admin.update.confirmTitle': 'Instalar atualização?',
  'admin.update.confirmText': 'O TripTrace será atualizado de {current} para {version}. O servidor reiniciará automaticamente em seguida.',
  ...
  'admin.update.dockerText': 'Sua instância TripTrace roda no Docker. Para atualizar para {version}, execute no servidor:',
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do TripTrace',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário TripTrace',
  ...
  'vacay.inviteHint': 'Convide outro usuário TripTrace para compartilhar um calendário de férias combinado.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} já está disponível.',
  ...
  'notif.version_available.text': 'TripTrace {version} está disponível',
  ...
  'journey.pdf.madeWith': 'Feito com TripTrace',
  'journey.pdf.day': 'Dia',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bem-vindo ao TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viagem pitoresco com a interface do TripTrace',
