const ru: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Спутники TripTrace',
  'settings.about.supporters.subtitle': 'Пока ты планируешь следующий маршрут, эти люди планируют вместе со мной будущее TripTrace. Их ежемесячный взнос идёт напрямую в разработку и реально потраченные часы — чтобы TripTrace оставался Open Source.',
  ...
  'settings.about.description': 'TripTrace — это самостоятельно размещаемый планировщик путешествий, который помогает организовать поездки от первой идеи до последнего воспоминания. Планирование по дням, бюджет, списки вещей, фото и многое другое — всё в одном месте, на вашем собственном сервере.',
  ...
  'login.createAdminHint': 'Настройте первый аккаунт администратора для TripTrace.',
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки TripTrace под себя.',
  ...
  'admin.weather.description': 'TripTrace использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.github.support': 'Помогает продолжать разработку TripTrace',
  'admin.github.error': 'Не удалось загрузить релизы',
  'admin.github.by': 'от',

  'admin.update.available': 'Доступно обновление',
  'admin.update.text': 'Доступна версия TripTrace {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'TripTrace будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText': 'Ваш экземпляр TripTrace работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями TripTrace',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя TripTrace',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя TripTrace для совместного календаря отпусков.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} теперь доступен.',
  ...
  'notif.version_available.text': 'TripTrace {version} теперь доступен',
  ...
  'journey.pdf.madeWith': 'Сделано с помощью TripTrace',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Добро пожаловать в TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописное место назначения с интерфейсом TripTrace',
