const nl: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Reisgezelschap voor TripTrace',
  'settings.about.supporters.subtitle': 'Terwijl jij je volgende route plant, plannen deze mensen mee aan de toekomst van TripTrace. Hun maandelijkse bijdrage gaat rechtstreeks naar ontwikkeling en echte uren — zodat TripTrace Open Source blijft.',
  ...
  'settings.about.description': 'TripTrace is een zelf-gehoste reisplanner die je helpt je reizen te organiseren van het eerste idee tot de laatste herinnering. Dagplanning, budget, paklijsten, foto\'s en nog veel meer — alles op één plek, op je eigen server.',
  'settings.about.madeWith': 'Gemaakt met',
  'settings.about.madeBy': 'door TripTrace team en een groeiende open-source community.',
  ...
  'login.createAdminHint': 'Stel het eerste beheerdersaccount in voor TripTrace.',
  ...
  'admin.addons.subtitle': 'Schakel functies in of uit om je TripTrace-ervaring aan te passen.',
  ...
  'admin.weather.description': 'TripTrace gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.github.support': 'Helpt mij TripTrace verder te ontwikkelen',
  'admin.github.error': 'Releases laden mislukt',
  'admin.github.by': 'door',

  'admin.update.available': 'Update beschikbaar',
  'admin.update.text': 'TripTrace {version} is beschikbaar. Je draait {current}.',
  'admin.update.button': 'Bekijk op GitHub',
  'admin.update.install': 'Update installeren',
  'admin.update.confirmTitle': 'Update installeren?',
  'admin.update.confirmText': 'TripTrace wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'admin.update.dockerText': 'Je TripTrace-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando\'s uit op je server:',
  ...
  'vacay.sharing': 'Delen',
  'vacay.sharingHint': 'Deel je vakantieplan met andere TripTrace-gebruikers',
  'vacay.owner': 'Eigenaar',
  'vacay.shareEmailPlaceholder': 'E-mail van TripTrace-gebruiker',
  ...
  'vacay.inviteHint': 'Nodig een andere TripTrace-gebruiker uit om een gecombineerde vakantiekalender te delen.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} is nu beschikbaar.',
  ...
  'notif.version_available.text': 'TripTrace {version} is nu beschikbaar',
  ...
  'journey.pdf.madeWith': 'Gemaakt met TripTrace',
  'journey.pdf.day': 'Dag',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Welkom bij TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'Schilderachtige reisbestemming met TripTrace interface',
