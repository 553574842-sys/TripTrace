const es: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Compañía de viaje para TripTrace',
  'settings.about.supporters.subtitle': 'Mientras planeas tu próxima ruta, estas personas ayudan a planear el futuro de TripTrace. Su aporte mensual va directo al desarrollo y a las horas reales invertidas — para que TripTrace siga siendo Open Source.',
  ...
  'settings.about.description': 'TripTrace es un planificador de viajes autoalojado que te ayuda a organizar tus viajes desde la primera idea hasta el último recuerdo. Planificación diaria, presupuesto, listas de equipaje, fotos y mucho más — todo en un solo lugar, en tu propio servidor.',
  'settings.about.madeWith': 'Hecho con',
  'settings.about.madeBy': 'por TripTrace team y una creciente comunidad de código abierto.',
  ...
  'login.createAdminHint': 'Configura la primera cuenta administradora de TripTrace.',
  ...
  'admin.addons.subtitle': 'Activa o desactiva funciones para personalizar tu experiencia en TripTrace.',
  ...
  'admin.weather.description': 'TripTrace utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.github.support': 'Ayuda a seguir desarrollando TripTrace',
  'admin.github.error': 'No se pudieron cargar las versiones',
  'admin.github.by': 'por',
  'admin.update.available': 'Actualización disponible',
  'admin.update.text': 'TripTrace {version} está disponible. Estás usando {current}.',
  ...
  'admin.update.confirmText': 'TripTrace se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'admin.update.dockerText': 'Tu instancia de TripTrace se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  ...
  'vacay.sharingHint': 'Comparte tu calendario de vacaciones con otros usuarios de TripTrace',
  'vacay.owner': 'Propietario',
  'vacay.shareEmailPlaceholder': 'Correo electrónico del usuario de TripTrace',
  ...
  'vacay.inviteHint': 'Invita a otro usuario de TripTrace a compartir un calendario combinado de vacaciones.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} ya está disponible.',
  ...
  'notif.version_available.text': 'TripTrace {version} ya está disponible',
  ...
  'journey.pdf.madeWith': 'Hecho con TripTrace',
  'journey.pdf.day': 'Día',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bienvenido a TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viaje pintoresco con la interfaz de TripTrace',
