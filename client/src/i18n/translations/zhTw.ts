const zhTw: Record<string, string> = {
  ...
  'settings.about.supporters.title': '與 TripTrace 同行的夥伴',
  'settings.about.supporters.subtitle': '當你規劃下一段路線時，這些人也在一起規劃 TripTrace 的未來。他們每月的支持直接用於開發與實際投入的時間——讓 TripTrace 保持開源。',
  ...
  'settings.about.description': 'TripTrace 是一款自架旅遊規劃器，幫助您從最初構想到最後回憶，整理每次旅行。日程規劃、預算、行李清單、照片及更多功能——全部集中在您自己的伺服器上。',
  'settings.about.madeWith': '以',
  'settings.about.madeBy': '由 TripTrace team 及不斷成長的開源社群製作。',
  ...
  'login.createAdminHint': '為 TripTrace 設定第一個管理員賬戶。',
  ...
  'admin.addons.subtitle': '啟用或停用功能以自定義你的 TripTrace 體驗。',
  ...
  'admin.weather.description': 'TripTrace 使用 Open-Meteo 作為天氣資料來源。Open-Meteo 是免費的開源天氣服務——無需 API 金鑰。',
  ...
  'admin.github.support': '幫助我繼續開發 TripTrace',
  'admin.github.error': '載入版本失敗',
  'admin.github.by': '作者',

  'admin.update.available': '有可用更新',
  'admin.update.text': 'TripTrace {version} 已釋出。你當前使用的是 {current}。',
  'admin.update.button': '在 GitHub 檢視',
  'admin.update.install': '安裝更新',
  'admin.update.confirmTitle': '確定安裝更新？',
  'admin.update.confirmText': 'TripTrace 將從 {current} 更新到 {version}。伺服器將自動重啟。',
  ...
  'admin.update.dockerText': '你的 TripTrace 例項執行在 Docker 中。要更新到 {version}，請在伺服器上執行以下命令：',
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '與其他 TripTrace 使用者共享你的假期計劃',
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'TripTrace 使用者郵箱',
  ...
  'vacay.inviteHint': '邀請其他 TripTrace 使用者共享合併的假期日曆。',
  ...
  'reservations.meta.noHotelPlace': '暫不關聯住宿地點',
  ...
  'reservations.attachmentsEmpty': '暫無附件，可新增訂單截圖、電子票或確認單',
  ...
  'journey.pdf.madeWith': '由 TripTrace 製作',
  'journey.pdf.day': '第',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} 現已推出。',
  ...
  'notif.version_available.text': 'TripTrace {version} 現已推出',
...
Object.assign(zhTw, {
  ...
  'trip.tabs.budget': '花費',
  'trip.tabs.files': '資料',
  'admin.addons.catalog.packing.name': '清單',
  'admin.addons.catalog.budget.name': '花費',
  'admin.addons.catalog.documents.name': '資料',
  'admin.addons.catalog.collab.name': '協作',
  'places.addPlace': '新增地點 / 活動',
  'places.importFile': '匯入檔案',
  'places.importList': '匯入清單',
  'places.all': '全部',
  'places.unplanned': '未安排',
  'places.search': '搜尋地點...',
  'places.allCategories': '全部分類',
  'places.count': '{count} 個地點',
  'places.countSingular': '1 個地點',
  'places.allPlanned': '所有地點都已安排',
  'places.noneFound': '沒有找到地點',
  'dayplan.deleteDay': '刪除當天行程',
  'dayplan.deleteDayTitle': '刪除當天行程？',
  'dayplan.deleteDayBody': '「{title}」中的地點安排、備註和交通關聯將被移除。此操作無法復原。',
  'dayplan.toast.dayDeleted': '當天行程已刪除',
  'dayplan.toast.deleteDayError': '刪除當天行程失敗',
  'dashboard.confirm.copy.title': '複製這個行程？',
  'dashboard.confirm.copy.willCopy': '將會複製',
  'dashboard.confirm.copy.will1': '天數、地點和每日安排',
  'dashboard.confirm.copy.will2': '住宿和預訂',
  'dashboard.confirm.copy.will3': '花費項目和分類順序',
  'dashboard.confirm.copy.will4': '行李清單（不保留勾選狀態）',
  'dashboard.confirm.copy.will5': '待辦事項（不分配、不保留勾選狀態）',
  'dashboard.confirm.copy.will6': '每日備註',
  'dashboard.confirm.copy.wontCopy': '不會複製',
  'dashboard.confirm.copy.wont1': '協作者和成員分配',
  'dashboard.confirm.copy.wont2': '協作筆記、投票和訊息',
  'dashboard.confirm.copy.wont3': '檔案和照片',
  'dashboard.confirm.copy.wont4': '分享連結',
  'dashboard.confirm.copy.confirm': '複製行程',
  'transport.addTransport': '新增交通',
  'transport.modalTitle.create': '新增交通',
  'transport.modalTitle.edit': '編輯交通',
  'transport.title': '交通',
  'transport.addManual': '手動新增交通',
  'transport.ai.title': 'AI 輔助填寫',
  'transport.ai.subtitle': '貼上訂單文字或上傳截圖，自動識別並填入下方欄位',
  'transport.ai.placeholder': '例如：南航 CZ3123，5月13日 14:30 從長沙黃花機場飛往北京大興機場，確認號 ABC123...',
  'transport.ai.uploadImage': '上傳截圖',
  'transport.ai.action': 'AI 識別',
  'transport.ai.parsing': '識別中...',
  'transport.ai.filled': '已根據 AI 結果填入表單',
  'transport.ai.error': 'AI 識別失敗',
  'transport.ai.needInput': '請先輸入描述或上傳截圖',
  'transport.ai.errorKeyMissing': '尚未配置 AI API Key，請先在後端環境變數中設定 AI_API_KEY。',
  'transport.ai.errorKeyInvalid': 'AI API Key 無效或沒有權限，請檢查密鑰是否填錯。',
  'transport.ai.errorModelUnavailable': '目前 AI 模型不可用，請檢查 AI_MODEL 配置或更換模型。',
  'transport.ai.errorImageTooLarge': '圖片太大，請壓縮截圖或改用文字描述。',
  'transport.ai.errorImageUnsupported': '檔案格式不支援，請上傳 PNG、JPG 或 WebP 截圖。',
  'transport.ai.errorParseFailed': 'AI 返回格式無法解析，請換一張更清晰的截圖或改用文字描述。',
  'transport.ai.errorEmptyResponse': 'AI 沒有返回可識別內容，請補充描述後重試。',
  'transport.ai.errorRateLimited': 'AI 調用額度不足或請求過於頻繁，請稍後再試。',
  'transport.ai.errorTimeout': 'AI 識別逾時，請稍後重試。',
  'transport.ai.errorProviderUnavailable': 'AI 服務暫時不可用，請檢查網路、Base URL 或稍後重試。',
  'transport.ai.errorRequestInvalid': 'AI 請求參數不正確，請檢查截圖、描述文字和模型配置。',
})
