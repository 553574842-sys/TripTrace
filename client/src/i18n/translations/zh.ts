const zh: Record<string, string> = {
  ...
  'settings.mapsKey': '高德地图 API Key',
  'settings.mapsKeyHint': '用于国内地点搜索和路线规划。请在高德开放平台申请 Web 服务 Key',
  ...
  'settings.about.supporters.title': '与 TripTrace 同行的伙伴',
  'settings.about.supporters.subtitle': '当你在规划下一段路线时，这些人也在一起规划 TripTrace 的未来。他们每月的支持直接用于开发与真实投入的时间——让 TripTrace 保持开源。',
  ...
  'settings.about.description': 'TripTrace 是一个自托管的旅行规划工具，帮助你从最初的想法到最后的回忆，全程组织你的旅行。日程规划、预算、行李清单、照片等——一切尽在一处，在你自己的服务器上。',
  'settings.about.madeWith': '用',
  'settings.about.madeBy': '由 TripTrace team 和不断壮大的开源社区打造。',
  ...
  'login.createAdminHint': '为 TripTrace 设置第一个管理员账户。',
  ...
  'admin.mapsKey': '高德地图 API Key',
  'admin.mapsKeyHint': '用于国内地点搜索和路线规划。请在高德开放平台申请',
  'admin.mapsKeyHintLong': '国内版路线规划已切换为高德地图。请填写高德 Web 服务 Key，用于驾车、步行和公交路线计算。',
  ...
  'admin.addons.subtitle': '启用或禁用功能以自定义你的 TripTrace 体验。',
  ...
  'admin.weather.description': 'TripTrace 使用 Open-Meteo 作为天气数据源。Open-Meteo 是免费的开源天气服务——无需 API 密钥。',
  ...
  'admin.github.support': '帮助我继续开发 TripTrace',
  'admin.github.error': '加载版本失败',
  'admin.github.by': '作者',

  'admin.update.available': '有可用更新',
  'admin.update.text': 'TripTrace {version} 已发布。你当前使用的是 {current}。',
  'admin.update.button': '在 GitHub 查看',
  'admin.update.install': '安装更新',
  'admin.update.confirmTitle': '确定安装更新？',
  'admin.update.confirmText': 'TripTrace 将从 {current} 更新到 {version}。服务器将自动重启。',
  ...
  'admin.update.dockerText': '你的 TripTrace 实例运行在 Docker 中。要更新到 {version}，请在服务器上执行以下命令：',
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '与其他 TripTrace 用户共享你的假期计划',
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'TripTrace 用户邮箱',
  ...
  'vacay.inviteHint': '邀请其他 TripTrace 用户共享合并的假期日历。',
  ...
  'places.osmHint': '国内版建议使用高德地图 Key 获取更完整的地点和路线能力。',
  'places.osmActive': '国内版建议使用高德地图 Key 获取更完整的地点和路线能力。',
  ...
  'reservations.empty': '暂无预订信息',
  'reservations.emptyHint': '添加住宿、餐厅、门票或活动预订',
  ...
  'reservations.meta.checkIn': '最早入住时间',
  'reservations.meta.checkInUntil': '最晚入住时间',
  'reservations.meta.checkOut': '退房时间',
  'reservations.meta.linkAccommodation': '住宿',
  'reservations.meta.pickAccommodation': '关联住宿',
  'reservations.meta.noAccommodation': '无',
  'reservations.meta.hotelPlace': '住宿地点',
  'reservations.meta.pickHotel': '选择已添加的住宿地点',
  'reservations.meta.noHotelPlace': '暂不关联住宿地点',
  'reservations.meta.fromDay': '入住日期',
  'reservations.meta.toDay': '退房日期',
  'reservations.meta.selectDay': '选择行程日期',
  'reservations.type.flight': '航班',
  'reservations.type.hotel': '住宿',
  'reservations.type.restaurant': '餐厅订位',
  'reservations.type.train': '火车',
  'reservations.type.car': '汽车',
  'reservations.type.cruise': '邮轮',
  'reservations.type.event': '门票 / 活动',
  'reservations.type.tour': '跟团 / 一日游',
  'reservations.type.other': '其他预订',
  ...
  'reservations.newTitle': '添加预订信息',
  'reservations.bookingType': '预订类型',
  'reservations.titleLabel': '预订名称',
  'reservations.titlePlaceholder': '如：全季酒店、故宫门票、四季民福订位...',
  'reservations.locationAddress': '地点',
  'reservations.locationPlaceholder': '输入地点名称或详细地址',
  'reservations.confirmationCode': '订单号 / 确认码',
  'reservations.confirmationPlaceholder': '输入平台订单号或商家确认码',
  'reservations.day': '日期',
  'reservations.noDay': '无日期',
  'reservations.place': '地点',
  'reservations.noPlace': '无地点',
  'reservations.pendingSave': '保存预订后上传',
  'reservations.uploading': '上传中...',
  'reservations.attachFile': '添加附件',
  'reservations.linkExisting': '关联已有附件',
  'reservations.attachments': '附件',
  'reservations.attachmentsEmpty': '暂无附件，可添加订单截图、电子票或确认单',
  ...
  'reservations.linkAssignment': '关联行程安排',
  'reservations.pickAssignment': '选择要关联的行程安排',
  'reservations.noAssignment': '暂不关联行程安排',
  'reservations.price': '预订金额',
  'reservations.budgetCategory': '费用分类',
  'reservations.budgetCategoryPlaceholder': '例：交通、住宿',
  'reservations.budgetCategoryAuto': '按预订类型自动分类',
  'reservations.budgetHint': '保存后会自动计入行程花费。',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} 现已可用。',
  ...
  'notif.version_available.text': 'TripTrace {version} 现已可用',
  ...
  'journey.pdf.madeWith': '由 TripTrace 制作',
  'journey.pdf.day': '第',
...
Object.assign(zh, {
  // TripTrace local wording overrides
  'trip.tabs.plan': '行程',
  'trip.tabs.transports': '交通',
  'trip.tabs.reservations': '预订',
  'trip.tabs.reservationsShort': '预订',
  'trip.tabs.packing': '行李',
  'trip.tabs.packingShort': '行李',
  'trip.tabs.lists': '清单',
  'trip.tabs.listsShort': '清单',
  'trip.tabs.budget': '花费',
  'trip.tabs.files': '资料',
  'admin.addons.catalog.packing.name': '清单',
  'admin.addons.catalog.budget.name': '花费',
  'admin.addons.catalog.documents.name': '资料',
  'admin.addons.catalog.collab.name': '协作',
  'places.addPlace': '添加地点 / 活动',
  'places.importFile': '导入文件',
  'places.importList': '导入清单',
  'places.all': '全部',
  'places.unplanned': '未安排',
  'places.search': '搜索地点...',
  'places.allCategories': '全部分类',
  'places.count': '{count} 个地点',
  'places.countSingular': '1 个地点',
  'places.allPlanned': '所有地点都已安排',
  'places.noneFound': '没有找到地点',
  'dayplan.deleteDay': '删除当天行程',
  'dayplan.deleteDayTitle': '删除当天行程？',
  'dayplan.deleteDayBody': '「{title}」中的地点安排、备注和交通关联将被移除。此操作无法撤销。',
  'dayplan.toast.dayDeleted': '当天行程已删除',
  'dayplan.toast.deleteDayError': '删除当天行程失败',
  'dashboard.confirm.copy.title': '复制这个行程？',
  'dashboard.confirm.copy.willCopy': '将会复制',
  'dashboard.confirm.copy.will1': '天数、地点和每日安排',
  'dashboard.confirm.copy.will2': '住宿和预订',
  'dashboard.confirm.copy.will3': '花费项目和分类顺序',
  'dashboard.confirm.copy.will4': '行李清单（不保留勾选状态）',
  'dashboard.confirm.copy.will5': '待办事项（不分配、不保留勾选状态）',
  'dashboard.confirm.copy.will6': '每日备注',
  'dashboard.confirm.copy.wontCopy': '不会复制',
  'dashboard.confirm.copy.wont1': '协作者和成员分配',
  'dashboard.confirm.copy.wont2': '协作笔记、投票和消息',
  'dashboard.confirm.copy.wont3': '文件和照片',
  'dashboard.confirm.copy.wont4': '分享链接',
  'dashboard.confirm.copy.confirm': '复制行程',
  'transport.addTransport': '添加交通',
  'transport.modalTitle.create': '添加交通',
  'transport.modalTitle.edit': '编辑交通',
  'transport.title': '交通',
  'transport.addManual': '手动添加交通',
  'transport.ai.title': 'AI 辅助填写',
  'transport.ai.subtitle': '粘贴订单文字或上传截图，自动识别并填入下方字段',
  'transport.ai.placeholder': '例如：南航 CZ3123，5月13日 14:30 从长沙黄花机场飞往北京大兴机场，确认号 ABC123...',
  'transport.ai.uploadImage': '上传截图',
  'transport.ai.action': 'AI 识别',
  'transport.ai.parsing': '识别中...',
  'transport.ai.filled': '已根据 AI 结果填入表单',
  'transport.ai.error': 'AI 识别失败',
  'transport.ai.needInput': '请先输入描述或上传截图',
  'transport.ai.errorKeyMissing': '尚未配置 AI API Key，请先在后端环境变量中设置 AI_API_KEY。',
  'transport.ai.errorKeyInvalid': 'AI API Key 无效或没有权限，请检查密钥是否填错。',
  'transport.ai.errorModelUnavailable': '当前 AI 模型不可用，请检查 AI_MODEL 配置或更换模型。',
  'transport.ai.errorImageTooLarge': '图片太大，请压缩截图或改用文字描述。',
  'transport.ai.errorImageUnsupported': '文件格式不支持，请上传 PNG、JPG 或 WebP 截图。',
  'transport.ai.errorParseFailed': 'AI 返回格式无法解析，请换一张更清晰的截图或改用文字描述。',
  'transport.ai.errorEmptyResponse': 'AI 没有返回可识别内容，请补充描述后重试。',
  'transport.ai.errorRateLimited': 'AI 调用额度不足或请求过于频繁，请稍后再试。',
  'transport.ai.errorTimeout': 'AI 识别超时，请稍后重试。',
  'transport.ai.errorProviderUnavailable': 'AI 服务暂时不可用，请检查网络、Base URL 或稍后重试。',
  'transport.ai.errorRequestInvalid': 'AI 请求参数不正确，请检查截图、描述文本和模型配置。',
})
