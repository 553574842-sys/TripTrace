...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'رفاق رحلة TripTrace',
  'settings.about.supporters.subtitle': 'بينما تخطّط لمسارك التالي، يساعد هؤلاء الأشخاص في التخطيط لمستقبل TripTrace. تذهب مساهمتهم الشهرية مباشرةً إلى التطوير والساعات الفعلية المبذولة — حتى يظلّ TripTrace مفتوح المصدر.',
  ...
  'settings.about.description': 'TripTrace هو مخطط سفر مستضاف ذاتيًا يساعدك على تنظيم رحلاتك من أول فكرة حتى آخر ذكرى. تخطيط يومي، ميزانية، قوائم تعبئة، صور والمزيد — كل شيء في مكان واحد، على خادمك الخاص.',
  ...
  'login.createAdminHint': 'أعد إعداد أول حساب مسؤول لـ TripTrace.',
  ...
  'admin.addons.subtitle': 'فعّل أو عطّل الميزات لتخصيص تجربة TripTrace.',
  ...
  'admin.weather.description': 'يستخدم TripTrace خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.',
  ...
  'admin.github.support': 'يساعدني في تطوير TripTrace',

  'admin.update.available': 'يتوفر تحديث',
  'admin.update.text': 'TripTrace {version} متوفر. أنت تستخدم {current}.',
  'admin.update.button': 'عرض على GitHub',
  'admin.update.install': 'تثبيت التحديث',
  'admin.update.confirmTitle': 'تثبيت التحديث؟',
  'admin.update.confirmText': 'سيتم تحديث TripTrace من {current} إلى {version}. سيُعاد تشغيل الخادم تلقائيًا بعد ذلك.',
  ...
  'admin.update.dockerText': 'يعمل TripTrace الخاص بك في Docker. للتحديث إلى {version}، نفّذ الأوامر التالية على الخادم:',
  ...
  'vacay.sharingHint': 'شارك خطة إجازاتك مع مستخدمي TripTrace الآخرين',
  'vacay.owner': 'المالك',
  'vacay.shareEmailPlaceholder': 'البريد الإلكتروني لمستخدم TripTrace',
  ...
  'vacay.inviteHint': 'ادعُ مستخدم TripTrace آخرًا لمشاركة تقويم إجازة مشترك.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} متاح الآن.',
  ...
  'notif.version_available.text': 'TripTrace {version} متاح الآن',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'مرحبًا بك في TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'وجهة سفر خلابة مع واجهة تطبيق TripTrace',
