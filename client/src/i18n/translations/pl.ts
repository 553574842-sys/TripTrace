const pl: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Towarzystwo podróży dla TripTrace',
  'settings.about.supporters.subtitle': 'Gdy planujesz kolejną trasę, te osoby planują razem ze mną przyszłość TripTrace. Ich comiesięczny wkład idzie bezpośrednio na rozwój i realnie przepracowane godziny — aby TripTrace pozostał Open Source.',
  ...
  'settings.about.description': 'TripTrace to samodzielnie hostowany planer podróży, który pomaga organizować wyprawy od pierwszego pomysłu po ostatnie wspomnienie. Planowanie dzienne, budżet, listy pakowania, zdjęcia i wiele więcej — wszystko w jednym miejscu, na własnym serwerze.',
  'settings.about.madeWith': 'Stworzone z',
  'settings.about.madeBy': 'przez TripTrace team\'a i rosnącą społeczność open-source.',
  ...
  'login.createAdminHint': 'Skonfiguruj pierwsze konto administratora dla TripTrace.',
  ...
  'admin.addons.subtitle': 'Włączaj lub wyłączaj funkcje, aby dostosować swoje doświadczenie w TripTrace.',
  ...
  'admin.weather.description': 'TripTrace korzysta z Open-Meteo jako źródła danych pogodowych. Open-Meteo to darmowy, otwartoźródłowy serwis pogodowy — klucz API nie jest wymagany.',
  ...
  'admin.github.support': 'Pomóż mi rozwijać TripTrace',

  'admin.update.available': 'Dostępna aktualizacja',
  'admin.update.text': 'Dostępna jest wersja TripTrace {version}. Używasz {current}.',
  ...
  'admin.update.confirmText': 'TripTrace zostanie zaktualizowany z {current} do {version}. Serwer zostanie automatycznie zrestartowany po zakończeniu.',
  ...
  'admin.update.dockerText': 'Twoja instancja TripTrace działa w Dockerze. Aby zaktualizować do {version}, uruchom następujące polecenia na swoim serwerze:',
  ...
  'vacay.sharingHint': 'Udostępnij swój plan urlopów innym użytkownikom TripTrace',
  'vacay.owner': 'Właściciel',
  'vacay.shareEmailPlaceholder': 'E-mail użytkownika TripTrace',
  ...
  'vacay.inviteHint': 'Zaproś innego użytkownika TripTrace do wspólnego kalendarza urlopów.',
  ...
  'notifications.versionAvailable.text': 'TripTrace {version} jest już dostępny.',
  ...
  'notif.version_available.text': 'TripTrace {version} jest teraz dostępny',
  ...
  'journey.pdf.madeWith': 'Stworzone z TripTrace',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Witaj w TripTrace',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malownicze miejsce z interfejsem planowania TripTrace',
