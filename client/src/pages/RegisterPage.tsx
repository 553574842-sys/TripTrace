      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 flex-col justify-center items-center p-12 text-white">
        <div className="max-w-sm text-center">
          ...
          <div className="mt-10 space-y-3 text-left">
            {[
              `âœ?${t('register.feature1')}`,
              `âœ?${t('register.feature2')}`,
              `âœ?${t('register.feature3')}`,
              `âœ?${t('register.feature4')}`,
              `âœ?${t('register.feature5')}`,
              `âœ?${t('register.feature6')}`,
            ].map(item => (
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-slate-50">
        <div className="w-full max-w-md">
          <div className="lg:hidden flex items-center gap-2 mb-8 justify-center">
            ...
            <span className="text-2xl font-bold text-slate-900">TripTrace</span>
          </div>
