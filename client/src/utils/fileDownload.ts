...
// Everything else (text/html, image/svg+xml, text/javascript, â€? is forced to
// download so a maliciously-named upload cannot run code in the TripTrace origin.
 ...
 * to download so that an uploaded file cannot run code in the TripTrace origin.
 *
 ...
 * â€?i.e. the file opened twice. The anchor approach avoids that ambiguity:
